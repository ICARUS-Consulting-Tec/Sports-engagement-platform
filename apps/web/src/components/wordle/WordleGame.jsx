  ...
  return (
    <section className="wordle-card">
      <header className="wordle-card-header">
        <p className="wordle-card-kicker">WORDLE MODE</p>
        <h2 className="wordle-card-title">Titans Crew Word Challenge</h2>
        <p className="wordle-card-copy">
          Un minijuego de 5 letras dentro del mismo apartado de Off-Season.
        </p>
      </header>
      ...
      <div className="wordle-layout">
        ...
        <aside className="wordle-sidebar">
          <WordleStats
            attemptsUsed={attempt + (gameStatus === "playing" ? 1 : 0)}
