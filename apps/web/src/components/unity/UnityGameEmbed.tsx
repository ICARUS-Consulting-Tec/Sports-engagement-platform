...
import { withBasePath } from "../../utils/runtimePaths";
...
function UnityGameEmbed({
  loaderUrl = withBasePath("Build/BuildPrototipo3.loader.js"),
  dataUrl = withBasePath("Build/BuildPrototipo3.data"),
  frameworkUrl = withBasePath("Build/BuildPrototipo3.framework.js"),
  codeUrl = withBasePath("Build/BuildPrototipo3.wasm"),
}: UnityGameEmbedProps) {
